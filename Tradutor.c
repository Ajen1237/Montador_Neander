...
int main(){
    ...
    while(fscanf(pont_arql, "%s", &leitura) != EOF){
        ...
        else if (strcmp(leitura, "STA") == 0){
            opcode=16;
            fwrite(&opcode,sizeof(opcode),1,pont_arqm);
            opcode=0;
            fwrite(&opcode,sizeof(opcode),1,pont_arqm);
            fscanf(pont_arql,"%x",&endereco);
            fwrite(&endereco,2,1,pont_arqm);
        }
        else if (strcmp(leitura, "LDA") == 0){
            opcode=32;
            fwrite(&opcode,sizeof(opcode),1,pont_arqm);
            opcode=0;
            fwrite(&opcode,sizeof(opcode),1,pont_arqm);
